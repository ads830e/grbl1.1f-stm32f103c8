  ...
  printPgmString("ALARM: ");
    ...
    switch (alarm_code) {
      ...
      case ALARM_PROBE_FAIL_INITIAL:
        printPgmString("Probe fail inital"); break;
      case ALARM_PROBE_FAIL_CONTACT:
        printPgmString("Probe fail contact"); break;
      case ALARM_HOMING_FAIL_RESET:
        printPgmString("Homing fail reset"); break;
      case ALARM_HOMING_FAIL_DOOR:
        printPgmString("Homing fail door"); break;
      case ALARM_HOMING_FAIL_PULLOFF:
        printPgmString("Homing fail pulloff"); break;
      case ALARM_HOMING_FAIL_APPROACH:
        printPgmString("Homing fail approach"); break;
      default:
        print_uint8_base10(alarm_code); break;
    }
  #endif
  report_util_line_feed();
  delay_ms(5);
