...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 120
  #define DEFAULT_Y_STEPS_PER_MM 120
  #define DEFAULT_Z_STEPS_PER_MM 120
  #define DEFAULT_X_MAX_RATE 60.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 60.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 60.0 // mm/min
  #define DEFAULT_X_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 95.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 95.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 95.0 // mm NOTE: Must be a positive value.
